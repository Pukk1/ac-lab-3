...
class OpcodeOperandsType(int, Enum):
    ...
    # 8-31 бит пустые
    NONE = 0b000
    # 8-11 бит пустые (либо под расширение специфики команды), 12-15 бит пустые, 16-31 бит заняты константой
    CONST = 0b001
    # 8-11 бит пустые (либо под расширение специфики команды), 12-27 бит константа, 28-31 бит регистр
    REG_CONST = 0b010
    # 8-19 бит пустые, 20-23 бит под регистр, 24-27 бит под регистр, 28-31 бит под регистр
    REG_REG_REG = 0b011
